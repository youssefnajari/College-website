...
<div id="formit">
  <div id="forma">
    <form action="" onsubmit="return verif()" method="post">
      ...
      <label for="s">Choose a subject </label>
      <div class="ppp">
              <select name="s" id="">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($n) || empty($fn) || empty($em) || empty($usn) || empty($psw) || empty($s)) {
        ...
        if (mysqli_num_rows($r2) == 0) {
            $r1 = mysqli_query($db, "INSERT INTO sign_in VALUES('$usn','$n','$fn','$psw','Teacher')");
            $r2 = mysqli_query($db, "INSERT INTO teacher VALUES('$usn','$n','$fn','$em','$s')");
